...
Page({
        ...
        onLoad: function (options) {
                ...
                var id = options.id;
                /*获取订单信息*/
                app.api_util.order_one(id, '加载中', function success(res) {
                        if (res.errcode == 0) {
                                that.setData({
                                        orders: res.result,
        ...
        /*撤销退款*/   //  url: '/pages/user/mineOrder/orderItems?id=' + 5
        cancelRefund:function(){
         var that=this;
         var id = that.data.orders.id;
         app.api_util.order_close_refund(id, '', function success(res) {
           if (res.errcode == 0) {
             wx.switchTab({
