...
Page({
        ...
        getCartData: function () {
                var that = this;
                app.api_util.trolley_list({}, "", function sussess(res) {
                        if (res.errcode == 0) {
                                var ass = res.result;
        ...
        get_home: function () {
                ...
                var that = this;
                app.api_util.homeData("", function sussess(res) {
                        if (res.errcode == 0) {
        ...
        brokeragerelation: function (parentId) {
                ...
                console.log("发起请求")
                //分销关系插入
                app.api_util.insertbrokeragerelation(data, '', function success(res) {
                        if (res.errcode == 0) {
        ...
        get_notice: function () {
                var that = this;
                app.api_util.getNoticeList("", function success(res) {
                        if (res.errcode == 0) {
                                that.setData({
                                        notice: res.result
                                })
        ...
        getquickentry: function () {
                var that = this;
                app.api_util.getquickentry("", function success(res) {
                        if (res.errcode == 0) {
        ...
        seckill: function () {
                var that = this;
                app.api_util.seckill({}, "", function success(res) {
                        if (res.errcode == 0) {
                                var sk = [];
        ...
        group: function () {
                var that = this;
                app.api_util.group({}, "", function success(res) {
                        if (res.errcode == 0) {
                                var list = res.result;
                                var sp = [];
                                for (var i = 0; i < list.length; i++) {
