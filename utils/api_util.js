...
module.exports = {
   ...
   * 
   */
  wechat_pay: function (body, outTradeNo, totalFee, openid,type) {
    var that = this;
    wx.getExtConfig({
...
*/
  relation: function (params, message, success, fail) {
    wx.getStorage({
      key: 'token',
      success: function (res) {
        var token = res.data;
        request_util.get_data(static_data.relation_url + '?token=' + token, params, message, success, fail);
      }
    })
  },
}